 ...
 * Embedded directly within the Order document in Firestore collection 'orders'.
 */
public class OrderItem {
    ...
    public OrderItem(String orderItemId, String orderId, String listingId, String cropId, String cropName,
                     Double quantity, String quantityUnit, BigDecimal agreedUnitPrice, String priceUnit,
