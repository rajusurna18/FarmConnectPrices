...
/**
 * Domain entity representing a Marketplace Review in Firestore collection 'reviews'.
 */
public class Review {
    private String reviewId;            // review_{orderId}_{reviewerUid}
    ...
    private String reviewerRole;        // FARMER, MEDIATOR_BUYER, CUSTOMER
    private String reviewerDisplayName;

    private String revieweeUid;
    private String revieweeRole;        // FARMER, MEDIATOR_BUYER, CUSTOMER
    ...
    public Review(String reviewId, String orderId, String listingId, String cropId, String cropName,
