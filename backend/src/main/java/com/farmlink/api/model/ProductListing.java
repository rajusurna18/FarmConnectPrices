...
/**
 * Domain entity representing a Marketplace Product Listing stored in Firestore collection 'productListings'.
 */
public class ProductListing {
    ...
    public ProductListing(String listingId, String ownerUid, String farmerProfileId, String cropId,
                          String cropName, Double quantity, Double availableQuantity, String unit,
                          Double askingPrice, String priceUnit, LocationDto location, String description,
                          String qualityGrade, String harvestDate, String availableFrom, String status,
    ...
    public String getFarmerProfileId() { return farmerProfileId; }
    public void setFarmerProfileId(String farmerProfileId) { this.farmerProfileId = farmerProfileId; }
