...
import { useFarmEconomic, useUpdateFarmEconomic } from '../hooks/useFarmEconomics';
...
export const EditFarmEconomicPage: React.FC = () => {
  ...
  const updateMutation = useUpdateFarmEconomic();
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Edit Crop Production Economics
          </h1>
          <p className="text-slate-400 text-sm">Update crop cost entries and yield estimates.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-slate-800/60 border border-slate-700/60 rounded-xl p-6 space-y-4 shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">Other Selling Costs (₹)</label>
              <input
                type="number"
                min="0"
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          >
            ...
            {updateMutation.isPending ? 'Updating...' : 'Update Economic Record'}
          </button>
        </div>
      </form>
    </div>
